...
const animations = 'data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full'

const toastVariants = cva([
	"group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-[1rem] py-3 px-4 pr-8 shadow-lg transition-all",
	animations
], {
	variants: {
		variant: {
			default: [
				"group border border-blue-400 bg-blue-500/20 text-blue-400 backdrop-blur-[1rem]",
				"light:border-blue-800 light:text-blue-800"
			],
			error: [
				"group border border-red-400 bg-red-500/20 text-red-400 backdrop-blur-[1rem]",
				"light:border-red-800 light:text-red-800"
			]
		},
	},
	defaultVariants: {
